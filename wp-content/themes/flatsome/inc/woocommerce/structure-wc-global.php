<?php
//include( get_template_directory() . '/flatsome-child/inc/woocommerce/structure-wc-global.php' );
...
if ( ! function_exists( 'flatsome_header_add_to_cart_fragment_count' ) ) {
	 ...
	 * @return mixed
	 */
	function flatsome_header_add_to_cart_fragment_count( $fragments ) {//namdeceloper
		ob_start();
		?>
		<span class="cart-icon image-icon icomoon-shopping-bag">
