				...
				if ( $woo_address_book_formatted_address ) :
					...
					<div class="wc-address-book-address">
						<div class="wc-address-book-meta">
							...
							<a id="<?php echo esc_attr( $woo_address_book_name ); ?>" class="wc-address-book-make-primary button secondary is-outline"><?php echo esc_attr__( 'Make Default', 'woo-address-book' ); ?></a>
						</div>
						<address>
							<?php //echo wp_kses( $woo_address_book_formatted_address, array( 'br' => array() ) ); ?>
							<?php
								//var_dump($woo_address_book_address);
							?>
							<ul>
								<li><span class="key">Fist name</span><span class="value"><?php echo ( $woo_address_book_address['first_name'] ? $woo_address_book_address['first_name'] : ' - ' ); ?></span></li>
								<li><span class="key">Last name</span><span class="value"><?php echo ( $woo_address_book_address['last_name'] ? $woo_address_book_address['last_name'] : ' - ' ); ?></span></li>
								<li><span class="key">Phone</span><span class="value"><?php echo ( $woo_address_book_address['phone'] ? $woo_address_book_address['phone'] : ' - ' ); ?></span></li>
								<li><span class="key">Address</span><span class="value"><?php echo ( $woo_address_book_address['address_1'] ? $woo_address_book_address['address_1'] : ' - ' ); ?></span></li>
							</ul>
						</address>
					</div>
