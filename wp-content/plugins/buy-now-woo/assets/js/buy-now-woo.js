jQuery(document).ready(function($) {
  ...
  $('body').on('click', '.js-wsb-add-to-cart', function(e) { //namdeveloper
    e.preventDefault();
    var $el = $(this);
    var variations_form = $el.parents('form.variations_form');
    if(variations_form.length > 0) {
      if(variations_form.find('input[name="variation_id"]').val() > 0) {
        console.log('buy now');
      }
      else {
