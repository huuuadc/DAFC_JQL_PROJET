<h1 id="product-genders">Product genders</h1>
<p>The product genders API allows you to create, view, update, and delete individual, or a batch, of genders.</p>
<h2 id="product-gender-properties">Product gender properties</h2>
<table>
    <thead>
        <tr>
            <th>Attribute</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>string</td>
            <td>gender name. <i class="label label-info">mandatory</i></td>
        </tr>
        <tr>
...
<h2 id="create-a-product-gender">Create a product gender</h2>
<p>This API helps you to create a new product gender.</p>
<h3 id="http-request">HTTP request</h3>
<div class="api-endpoint">
    <div class="endpoint-data">
        <i class="label label-post">POST</i>
        <h6>/wp-json/wc/v3/products/genders</h6>
    </div>
</div>

<blockquote>
    <p>Example of how to create a product gender:</p>
</blockquote>
<div class="highlight">
    <pre class="highlight shell tab-shell" style=""><code>curl <span class="nt">-X</span> POST <?php echo $domain; ?>wp-json/wc/v3/products/genders <span class="se">\</span>
...
<div class="highlight">
  ...
  <span class="na">name</span><span class="p">:</span> <span class="dl">"</span><span class="s2">Women</span><span class="dl">"</span><span class="p">,</span>
...
<span class="nx">WooCommerce</span><span class="p">.</span><span class="nx">post</span><span class="p">(</span><span class="dl">"</span><span class="s2">products/genders</span><span class="dl">"</span><span class="p">,</span> <span class="nx">data</span><span class="p">)</span>
...
<span class="nv">$data</span> <span class="o">=</span> <span class="p">[</span>
    <span class="s2">"name' =&gt; 'Women',
    'image' =&gt; [
        'src' =&gt; 'http://demo.woothemes.com/woocommerce/wp-content/uploads/sites/56/2013/06/T_2_front.jpg'
    ]
];

print_r(</span><span class="nv">$woocommerce-&gt;post</span><span class="s2">('products/genders', </span><span class="nv">$data</span><span class="s2">));
?&gt;
</span></code></pre>
</div>
<div class="highlight">
    <pre class="highlight python tab-python" style="display: none;"><code><span class="n">data</span> <span class="o">=</span> <span class="p">{</span>
    <span class="s">"name"</span><span class="p">:</span> <span class="s">"Women"</span><span class="p">,</span>
...
<span class="k">print</span><span class="p">(</span><span class="n">wcapi</span><span class="p">.</span><span class="n">post</span><span class="p">(</span><span class="s">"products/genders"</span><span class="p">,</span> <span class="n">data</span><span class="p">).</span><span class="n">json</span><span class="p">())</span>
</code></pre>
</div>
<div class="highlight">
    <pre class="highlight ruby tab-ruby" style="display: none;"><code><span class="n">data</span> <span class="o">=</span> <span class="p">{</span>
  <span class="ss">name: </span><span class="s2">"Women"</span><span class="p">,</span>
...
<span class="n">woocommerce</span><span class="p">.</span><span class="nf">post</span><span class="p">(</span><span class="s2">"products/genders"</span><span class="p">,</span> <span class="n">data</span><span class="p">).</span><span class="nf">parsed_response</span>
</code></pre>
</div>
<blockquote>
...
<div class="highlight">
    <pre class="highlight json tab-json"><code><span class="p">{</span><span class="w">
  ...
  </span><span class="nl">"name"</span><span class="p">:</span><span class="w"> </span><span class="s2">"Women"</span><span class="p">,</span><span class="w">
  </span><span class="nl">"slug"</span><span class="p">:</span><span class="w"> </span><span class="s2">"women"</span><span class="p">,</span><span class="w">
        ...
        </span><span class="nl">"href"</span><span class="p">:</span><span class="w"> </span><span class="s2">"<?php echo $domain; ?>wp-json/wc/v3/products/genders/9"</span><span class="w">
      </span><span class="p">}</span><span class="w">
    </span><span class="p">],</span><span class="w">
    </span><span class="nl">"collection"</span><span class="p">:</span><span class="w"> </span><span class="p">[</span><span class="w">
      </span><span class="p">{</span><span class="w">
        </span><span class="nl">"href"</span><span class="p">:</span><span class="w"> </span><span class="s2">"<?php echo $domain; ?>wp-json/wc/v3/products/genders"</span><span class="w">
      </span><span class="p">}</span><span class="w">
    </span><span class="p">]</span><span class="w">
  </span><span class="p">}</span><span class="w">
</span><span class="p">}</span><span class="w">
...
<h2 id="retrieve-a-product-gender">Retrieve a product gender</h2>
<p>This API lets you retrieve a product gender by ID.</p>

<div class="api-endpoint">
    <div class="endpoint-data">
        <i class="label label-get">GET</i>
        <h6>/wp-json/wc/v3/products/genders/&lt;id&gt;</h6>
    </div>
</div>
<div class="highlight">
    <pre class="highlight shell tab-shell" style=""><code>curl <?php echo $domain; ?>wp-json/wc/v3/products/genders/9 <span class="se">\</span>
...
<div class="highlight">
    <pre
        ...
        style="display: none;"
    ><code><span class="nx">WooCommerce</span><span class="p">.</span><span class="kd">get</span><span class="p">(</span><span class="dl">"</span><span class="s2">products/genders/9</span><span class="dl">"</span><span class="p">)</span>
  <span class="p">.</span><span class="nx">then</span><span class="p">((</span><span class="nx">response</span><span class="p">)</span> <span class="o">=&gt;</span> <span class="p">{</span>
    <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">response</span><span class="p">.</span><span class="nx">data</span><span class="p">);</span>
  <span class="p">})</span>
  <span class="p">.</span><span class="k">catch</span><span class="p">((</span><span class="nx">error</span><span class="p">)</span> <span class="o">=&gt;</span> <span class="p">{</span>
...
<div class="highlight">
    <pre
        ...
        style="display: none;"
    ><code><span class="cp">&lt;?php</span> <span class="nb">print_r</span><span class="p">(</span><span class="nv">$woocommerce</span><span class="o">-&gt;</span><span class="nf">get</span><span class="p">(</span><span class="s1">'products/genders/9'</span><span class="p">));</span> <span class="cp">?&gt;</span>
</code></pre>
</div>
<div class="highlight">
    <pre
        ...
        style="display: none;"
    ><code><span class="k">print</span><span class="p">(</span><span class="n">wcapi</span><span class="p">.</span><span class="n">get</span><span class="p">(</span><span class="s">"products/genders/9"</span><span class="p">).</span><span class="n">json</span><span class="p">())</span>
</code></pre>
</div>
<div class="highlight">
    <pre
        ...
        style="display: none;"
    ><code><span class="n">woocommerce</span><span class="p">.</span><span class="nf">get</span><span class="p">(</span><span class="s2">"products/genders/9"</span><span class="p">).</span><span class="nf">parsed_response</span>
</code></pre>
</div>
<blockquote>
    <p>JSON response example:</p>
...
<h2 id="list-all-product-genders">List all product genders</h2>
<p>This API lets you retrieve all product genders.</p>
...
<div class="highlight">
    <pre class="highlight shell tab-shell" style=""><code>curl <?php echo $domain; ?>wp-json/wc/v3/products/genders <span class="se">\</span>
    <span class="nt">-u</span> consumer_key:consumer_secret
</code></pre>
</div>
<div class="highlight">
    <pre
        class="highlight javascript tab-javascript"
        style="display: none;"
    ><code><span class="nx">WooCommerce</span><span class="p">.</span><span class="kd">get</span><span class="p">(</span><span class="dl">"</span><span class="s2">products/genders</span><span class="dl">"</span><span class="p">)</span>
  <span class="p">.</span><span class="nx">then</span><span class="p">((</span><span class="nx">response</span><span class="p">)</span> <span class="o">=&gt;</span> <span class="p">{</span>
    <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">response</span><span class="p">.</span><span class="nx">data</span><span class="p">);</span>
  <span class="p">})</span>
  <span class="p">.</span><span class="k">catch</span><span class="p">((</span><span class="nx">error</span><span class="p">)</span> <span class="o">=&gt;</span> <span class="p">{</span>
...
<div class="highlight">
    <pre
        class="highlight php tab-php"
        style="display: none;"
    ><code><span class="cp">&lt;?php</span> <span class="nb">print_r</span><span class="p">(</span><span class="nv">$woocommerce</span><span class="o">-&gt;</span><span class="nf">get</span><span class="p">(</span><span class="s1">'products/genders'</span><span class="p">));</span> <span class="cp">?&gt;</span>
</code></pre>
</div>
<div class="highlight">
    <pre
        class="highlight python tab-python"
        style="display: none;"
    ><code><span class="k">print</span><span class="p">(</span><span class="n">wcapi</span><span class="p">.</span><span class="n">get</span><span class="p">(</span><span class="s">"products/genders"</span><span class="p">).</span><span class="n">json</span><span class="p">())</span>
</code></pre>
</div>
<div class="highlight">
    <pre
        class="highlight ruby tab-ruby"
        style="display: none;"
    ><code><span class="n">woocommerce</span><span class="p">.</span><span class="nf">get</span><span class="p">(</span><span class="s2">"products/genders"</span><span class="p">).</span><span class="nf">parsed_response</span>
</code></pre>
</div>
<blockquote>
    <p>JSON response example:</p>
...
<div class="highlight">
    <pre class="highlight json tab-json"><code><span class="p">[</span><span class="w">
          ...
          </span><span class="nl">"href"</span><span class="p">:</span><span class="w"> </span><span class="s2">"<?php echo $domain; ?>wp-json/wc/v3/products/genders/15"</span><span class="w">
        </span><span class="p">}</span><span class="w">
      </span><span class="p">],</span><span class="w">
      </span><span class="nl">"collection"</span><span class="p">:</span><span class="w"> </span><span class="p">[</span><span class="w">
        </span><span class="p">{</span><span class="w">
          ...
          </span><span class="nl">"href"</span><span class="p">:</span><span class="w"> </span><span class="s2">"<?php echo $domain; ?>wp-json/wc/v3/products/genders/11"</span><span class="w">
        </span><span class="p">}</span><span class="w">
      </span><span class="p">]</span><span class="w">
    </span><span class="p">}</span><span class="w">
  </span><span class="p">},</span><span class="w">
          ...
          </span><span class="nl">"href"</span><span class="p">:</span><span class="w"> </span><span class="s2">"https://example/wp-json/wc/v3/products/genders/9"</span><span class="w">
        </span><span class="p">}</span><span class="w">
      </span><span class="p">],</span><span class="w">
      </span><span class="nl">"collection"</span><span class="p">:</span><span class="w"> </span><span class="p">[</span><span class="w">
        </span><span class="p">{</span><span class="w">
          </span><span class="nl">"href"</span><span class="p">:</span><span class="w"> </span><span class="s2">"https://example/wp-json/wc/v3/products/genders"</span><span class="w">
        </span><span class="p">}</span><span class="w">
      </span><span class="p">]</span><span class="w">
    </span><span class="p">}</span><span class="w">
  </span><span class="p">},</span><span class="w">
          ...
          </span><span class="nl">"href"</span><span class="p">:</span><span class="w"> </span><span class="s2">"<?php echo $domain; ?>wp-json/wc/v3/products/genders/10"</span><span class="w">
        </span><span class="p">}</span><span class="w">
      </span><span class="p">],</span><span class="w">
      </span><span class="nl">"collection"</span><span class="p">:</span><span class="w"> </span><span class="p">[</span><span class="w">
        </span><span class="p">{</span><span class="w">
          ...
          </span><span class="nl">"href"</span><span class="p">:</span><span class="w"> </span><span class="s2">"<?php echo $domain; ?>wp-json/wc/v3/products/genders/12"</span><span class="w">
        </span><span class="p">}</span><span class="w">
      </span><span class="p">],</span><span class="w">
      </span><span class="nl">"collection"</span><span class="p">:</span><span class="w"> </span><span class="p">[</span><span class="w">
        </span><span class="p">{</span><span class="w">
          ...
          </span><span class="nl">"href"</span><span class="p">:</span><span class="w"> </span><span class="s2">"<?php echo $domain; ?>wp-json/wc/v3/products/genders/13"</span><span class="w">
        </span><span class="p">}</span><span class="w">
      </span><span class="p">],</span><span class="w">
      </span><span class="nl">"collection"</span><span class="p">:</span><span class="w"> </span><span class="p">[</span><span class="w">
        </span><span class="p">{</span><span class="w">
          ...
          </span><span class="nl">"href"</span><span class="p">:</span><span class="w"> </span><span class="s2">"<?php echo $domain; ?>wp-json/wc/v3/products/genders/14"</span><span class="w">
        </span><span class="p">}</span><span class="w">
      </span><span class="p">],</span><span class="w">
      </span><span class="nl">"collection"</span><span class="p">:</span><span class="w"> </span><span class="p">[</span><span class="w">
        </span><span class="p">{</span><span class="w">
...
<h2 id="update-a-product-gender">Update a product gender</h2>
<p>This API lets you make changes to a product gender.</p>
...
<div class="highlight">
    <pre class="highlight shell tab-shell" style=""><code>curl <span class="nt">-X</span> PUT <?php echo $domain; ?>wp-json/wc/v3/products/genders/9 <span class="se">\</span>
    <span class="nt">-u</span> consumer_key:consumer_secret <span class="se">\</span>
    <span class="nt">-H</span> <span class="s2">"Content-Type: application/json"</span> <span class="se">\</span>
    <span class="nt">-d</span> <span class="s1">'{
...
<span class="nx">WooCommerce</span><span class="p">.</span><span class="nx">put</span><span class="p">(</span><span class="dl">"</span><span class="s2">products/genders/9</span><span class="dl">"</span><span class="p">,</span> <span class="nx">data</span><span class="p">)</span>
  <span class="p">.</span><span class="nx">then</span><span class="p">((</span><span class="nx">response</span><span class="p">)</span> <span class="o">=&gt;</span> <span class="p">{</span>
    <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">response</span><span class="p">.</span><span class="nx">data</span><span class="p">);</span>
  <span class="p">})</span>
  <span class="p">.</span><span class="k">catch</span><span class="p">((</span><span class="nx">error</span><span class="p">)</span> <span class="o">=&gt;</span> <span class="p">{</span>
...
<span class="nb">print_r</span><span class="p">(</span><span class="nv">$woocommerce</span><span class="o">-&gt;</span><span class="nf">put</span><span class="p">(</span><span class="s1">'products/genders/9'</span><span class="p">,</span> <span class="nv">$data</span><span class="p">));</span>
<span class="cp">?&gt;</span>
</code></pre>
</div>
<div class="highlight">
...
<span class="k">print</span><span class="p">(</span><span class="n">wcapi</span><span class="p">.</span><span class="n">put</span><span class="p">(</span><span class="s">"products/genders/9"</span><span class="p">,</span> <span class="n">data</span><span class="p">).</span><span class="n">json</span><span class="p">())</span>
</code></pre>
</div>
<div class="highlight">
    <pre class="highlight ruby tab-ruby" style="display: none;"><code><span class="n">data</span> <span class="o">=</span> <span class="p">{</span>
...
<span class="n">woocommerce</span><span class="p">.</span><span class="nf">put</span><span class="p">(</span><span class="s2">"products/genders/9"</span><span class="p">,</span> <span class="n">data</span><span class="p">).</span><span class="nf">parsed_response</span>
</code></pre>
</div>
<blockquote>
    <p>JSON response example:</p>
...
<h2 id="delete-a-product-gender">Delete a product gender</h2>
<p>This API helps you delete a product gender.</p>
...
<div class="highlight">
    <pre class="highlight shell tab-shell" style=""><code>curl <span class="nt">-X</span> DELETE <?php echo $domain; ?>wp-json/wc/v3/products/genders/9?force<span class="o">=</span><span class="nb">true</span> <span class="se">\</span>
    <span class="nt">-u</span> consumer_key:consumer_secret
</code></pre>
</div>
<div class="highlight">
    <pre
        class="highlight javascript tab-javascript"
        style="display: none;"
    ><code><span class="nx">WooCommerce</span><span class="p">.</span><span class="k">delete</span><span class="p">(</span><span class="dl">"</span><span class="s2">products/genders/9</span><span class="dl">"</span><span class="p">,</span> <span class="p">{</span>
...
<div class="highlight">
    <pre
        class="highlight php tab-php"
        style="display: none;"
    ><code><span class="cp">&lt;?php</span> <span class="nb">print_r</span><span class="p">(</span><span class="nv">$woocommerce</span><span class="o">-&gt;</span><span class="nb">delete</span><span class="p">(</span><span class="s1">'products/genders/9'</span><span class="p">,</span> <span class="p">[</span><span class="s1">'force'</span> <span class="o">=&gt;</span> <span class="kc">true</span><span class="p">]));</span> <span class="cp">?&gt;</span>
</code></pre>
</div>
<div class="highlight">
    <pre
        class="highlight python tab-python"
        style="display: none;"
    ><code><span class="k">print</span><span class="p">(</span><span class="n">wcapi</span><span class="p">.</span><span class="n">delete</span><span class="p">(</span><span class="s">"products/genders/9"</span><span class="p">,</span> <span class="n">params</span><span class="o">=</span><span class="p">{</span><span class="s">"force"</span><span class="p">:</span> <span class="bp">True</span><span class="p">}).</span><span class="n">json</span><span class="p">())</span>
</code></pre>
</div>
<div class="highlight">
    <pre
        class="highlight ruby tab-ruby"
        style="display: none;"
    ><code><span class="n">woocommerce</span><span class="p">.</span><span class="nf">delete</span><span class="p">(</span><span class="s2">"products/genders/9"</span><span class="p">,</span> <span class="ss">force: </span><span class="kp">true</span><span class="p">).</span><span class="nf">parsed_response</span>
</code></pre>
</div>
<blockquote>
    <p>JSON response example:</p>
...
<!-- <h2 id="batch-update-product-genders">Batch update product genders</h2>
<p>This API helps you to batch create, update and delete multiple product genders.</p>
...
<div class="api-endpoint">
    <div class="endpoint-data">
        <i class="label label-post">POST</i>
        <h6>/wp-json/wc/v3/products/genders/batch</h6>
    </div>
</div>
<div class="highlight">
    <pre class="highlight shell tab-shell" style=""><code>curl <span class="nt">-X</span> POST <?php echo $domain; ?>/wp-json/wc/v3/products/genders/batch <span class="se">\</span>
    <span class="nt">-u</span> consumer_key:consumer_secret <span class="se">\</span>
    <span class="nt">-H</span> <span class="s2">"Content-Type: application/json"</span> <span class="se">\</span>
    <span class="nt">-d</span> <span class="s1">'{
  "create": [
...
<div class="highlight">
  ...
  <span class="na">create</span><span class="p">:</span> <span class="p">[</span>
    ...
    <span class="p">},</span>
    <span class="p">{</span>
      <span class="na">name</span><span class="p">:</span> <span class="dl">"</span><span class="s2">Women</span><span class="dl">"</span>
    <span class="p">}</span>
  <span class="p">],</span>
...
<span class="nx">WooCommerce</span><span class="p">.</span><span class="nx">post</span><span class="p">(</span><span class="dl">"</span><span class="s2">products/genders/batch</span><span class="dl">"</span><span class="p">,</span> <span class="nx">data</span><span class="p">)</span>
  <span class="p">.</span><span class="nx">then</span><span class="p">((</span><span class="nx">response</span><span class="p">)</span> <span class="o">=&gt;</span> <span class="p">{</span>
    <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">response</span><span class="p">.</span><span class="nx">data</span><span class="p">);</span>
  <span class="p">})</span>
  <span class="p">.</span><span class="k">catch</span><span class="p">((</span><span class="nx">error</span><span class="p">)</span> <span class="o">=&gt;</span> <span class="p">{</span>
...
<span class="nv">$data</span> <span class="o">=</span> <span class="p">[</span>
    <span class="s1">'create'</span> <span class="o">=&gt;</span> <span class="p">[</span>
        ...
        <span class="p">],</span>
        <span class="p">[</span>
            <span class="s1">'name'</span> <span class="o">=&gt;</span> <span class="s1">'Women'</span>
        <span class="p">]</span>
    <span class="p">],</span>
...
<span class="nb">print_r</span><span class="p">(</span><span class="nv">$woocommerce</span><span class="o">-&gt;</span><span class="nf">post</span><span class="p">(</span><span class="s1">'products/genders/batch'</span><span class="p">,</span> <span class="nv">$data</span><span class="p">));</span>
<span class="cp">?&gt;</span>
</code></pre>
</div>
<div class="highlight">
    ...
    <span class="s">"create"</span><span class="p">:</span> <span class="p">[</span>
        ...
        <span class="p">},</span>
        <span class="p">{</span>
            <span class="s">"name"</span><span class="p">:</span> <span class="s">"Women"</span>
        <span class="p">}</span>
    <span class="p">],</span>
...
<span class="k">print</span><span class="p">(</span><span class="n">wcapi</span><span class="p">.</span><span class="n">post</span><span class="p">(</span><span class="s">"products/genders/batch"</span><span class="p">,</span> <span class="n">data</span><span class="p">).</span><span class="n">json</span><span class="p">())</span>
</code></pre>
</div>
<div class="highlight">
    <pre class="highlight ruby tab-ruby" style="display: none;"><code><span class="n">data</span> <span class="o">=</span> <span class="p">{</span>
  <span class="ss">create: </span><span class="p">[</span>
    ...
    <span class="p">},</span>
    <span class="p">{</span>
      <span class="ss">name: </span><span class="s2">"Women"</span>
    <span class="p">}</span>
  <span class="p">],</span>
...
<span class="n">woocommerce</span><span class="p">.</span><span class="nf">post</span><span class="p">(</span><span class="s2">"products/genders/batch"</span><span class="p">,</span> <span class="n">data</span><span class="p">).</span><span class="nf">parsed_response</span>
</code></pre>
</div>
<blockquote>
    <p>JSON response example:</p>
