...
<ul class="woof_list woof_list_checkbox">
    ...
    <?php if (!empty($terms) AND is_array($terms)): ?>
        ...
        <li class="woof_childs_list_li">
            <input type="checkbox" data-tax="<?php echo $tax_slug; ?>" id="<?php echo $tax_slug; ?>_all" class="woof_checkbox_term woof_checkbox_term_all" <?php echo (count($current_request) == 0 ? 'checked="checked"' : ''); ?>>
            <label class="woof_checkbox_label" for="<?php echo $tax_slug; ?>_all">All</label>
        </li>
