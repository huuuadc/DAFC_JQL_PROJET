...
<section class="woocommerce-order-details">
	...
	<table class="woocommerce-table woocommerce-table--order-details shop_table order_details_thankyou">

		<thead>
			<tr>
				<th class="woocommerce-table__product-name product-name"><?php esc_html_e( 'Product', 'woocommerce' ); ?></th>
				<th class="woocommerce-table__product-price product-price"><?php esc_html_e( 'Price', 'Glamoutlet' ); ?></th>
				<th class="woocommerce-table__product-quantity product-quantity"><?php esc_html_e( 'Quantity', 'Glamoutlet' ); ?></th>
				<th class="woocommerce-table__product-table product-Subtotal"><?php esc_html_e( 'Subtotal', 'woocommerce' ); ?></th>
			</tr>
		</thead>
...
if ( $show_customer_details ) {
	//wc_get_template( 'order/order-details-customer-thankyou.php', array( 'order' => $order ) );
}
