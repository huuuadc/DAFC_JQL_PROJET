...
function cptui_register_my_taxes_product_shop() {
	...
	$labels = [
		"name" => __( "Shop By", "custom-post-type-ui" ),
		"singular_name" => __( "Shop By", "custom-post-type-ui" ),
	];

	
	$args = [
		"label" => __( "Shop By", "custom-post-type-ui" ),
		"labels" => $labels,
		"public" => true,
		"publicly_queryable" => true,
		"hierarchical" => true,
...
add_action( 'init', 'cptui_register_my_taxes_product_shop' );
