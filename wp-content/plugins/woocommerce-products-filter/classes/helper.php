...
//	}
    ...
    public static function draw_title_toggle($show, $block_is_closed) {
        ...
        if ($block_is_closed) {
            $toggle_text = ((isset($WOOF->settings['toggle_closed_text']) AND!empty($WOOF->settings['toggle_closed_text'])) ? self::wpml_translate(null, $WOOF->settings['toggle_closed_text']) : '<i class="icomoon-arrow-down-thin"></i>');
            ...
            $toggle_text = ((isset($WOOF->settings['toggle_opened_text']) AND!empty($WOOF->settings['toggle_opened_text'])) ? self::wpml_translate(null, $WOOF->settings['toggle_opened_text']) : '<i class="icomoon-arrow-up-thin"></i>');
