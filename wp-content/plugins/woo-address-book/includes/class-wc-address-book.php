...
class WC_Address_Book {
	...
	public function add_additional_address_button() {
		...
		<?php /*<div class="add-new-address">
			<a href="<?php echo esc_url( $this->get_address_book_endpoint_url( $name ) ); ?>" class="add button secondary"><?php echo esc_html_e( '+ Add New Address', 'woo-address-book' ); ?></a>
		</div>*/ ?>
		<a href="<?php echo esc_url( $this->get_address_book_endpoint_url( $name ) ); ?>" class="add button secondary"><?php echo esc_html_e( '+ Add New Address', 'woo-address-book' ); ?></a>
