        ...
        if ($woof_set_automatically === 1 AND!isset($_REQUEST['woof_before_shop_loop_done'])) {
            ...
            echo '<div class="filter-and-sort">';
                echo '<div class="wrapper-filter-sort">';
                    echo '<button id="toggleFilter" class="toggle-filter ignore-close-filter">Filter <strong style="display:none"></strong> <i class="icomoon-arrow-down ignore-close-filter"></i><i class="icomoon-arrow-up ignore-close-filter" style="display:none""></i></button>';
                    do_action('flatsome_category_title_alt');
                echo '</div>';
                echo '<div id="wrapperFilter" class="wrapper-filter" style="display:none">';
