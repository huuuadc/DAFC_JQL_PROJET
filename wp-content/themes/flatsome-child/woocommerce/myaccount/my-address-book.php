			...
			foreach ( $woo_address_book_address_book as $woo_address_book_name => $woo_address_book_fields ) :
				...
				$woo_address_book_address = apply_filters(
					...
					array(
						...
						'district'   => get_user_meta( $woo_address_book_customer_id, $woo_address_book_name . '_district', true ),
				...
				if ( $woo_address_book_formatted_address ) :
					...
					<div class="wc-address-book-address">
						<div class="wc-address-book-meta">
							...
							<a id="<?php echo esc_attr( $woo_address_book_name ); ?>" class="wc-address-book-make-primary button secondary is-outline"><?php echo esc_attr__( 'Default', 'woo-address-book' ); ?></a>
						</div>
						<address>
							...
							?>
							<ul>
								<li><span class="key">Name</span><span class="value"><?php echo ( $woo_address_book_address['first_name'] .  ' ' . $woo_address_book_address['last_name'] ); ?></span></li>
								...
								<li><span class="key">Address</span><span class="value"><?php echo ( $woo_address_book_address['address_1']  . '<br/>' . $woo_address_book_address['district']  . '<br/>' . $woo_address_book_address['city'] ); ?></span></li>
							</ul>
						</address>
					</div>
