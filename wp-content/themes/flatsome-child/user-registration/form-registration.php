...
?>
			...
			if ( $is_field_exists ) {
				?>
					...
					<div class="ur-button-container <?php echo esc_attr( implode( ' ', $btn_container_class ) ); ?>" >
						...
						echo '<span class="text-before-submit-button">Sign up to stay up to date with new offers!</span>';
						...
						<span class="text-after-submit-button">* All fields are required</span>
	...
	<a id="triggerRegisterSuccessPopup" href="#registerSuccessPopup" style="display: none;">.</a>
	<div id="registerSuccessPopup" class="lightbox-by-id lightbox-content mfp-hide lightbox-white accountPopup">
	...
	jQuery(document).ready(function(){
		jQuery('#dob').inputmask({alias:"datetime", inputFormat: "dd/mm/yyyy", min: "01/01/1900", max: "31/12/2020"});
		jQuery('#dob').css({'text-transform': 'uppercase'});
	});
	</script>
<?php
