...
<h3 class="form-title"><?php _e('New Password', 'glamoutlet'); ?></h3>
<p style="padding: 0 10px;"><?php echo apply_filters( 'user_registration_reset_password_message', __( 'Enter a new password below.', 'user-registration' ) ); ?></p>
		...
		<div class="ur-form-row">
			<div class="ur-form-grid">
				...
				<p class="user-registration-form-row form-row">
					...
					<input type="submit" class="user-registration-Button button secondary" value="<?php esc_attr_e( 'Save', 'user-registration' ); ?>" />
				</p>
