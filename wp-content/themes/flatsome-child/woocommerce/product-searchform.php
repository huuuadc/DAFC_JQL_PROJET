...
<form role="search" method="get" class="searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	<div class="flex-row relative">
		...
		<div class="flex-col flex-grow">
			...
			<?php echo get_flatsome_icon( 'icomoon-close mfp-close' ); ?>
		...
		<div class="flex-col">
			<button type="submit" value="<?php echo esc_attr_x( 'Search', 'submit button', 'woocommerce' ); ?>" class="ux-search-submit submit-button secondary button icon mb-0" aria-label="<?php esc_attr_e( 'Submit', 'flatsome' ); ?>" style="background-color:transparent!important">
				<?php echo get_flatsome_icon( 'icomoon-search' ); ?>
			</button>
		</div>
	</div>
